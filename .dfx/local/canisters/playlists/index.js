...
import { idlFactory } from './playlists.did.js';
export { idlFactory } from './playlists.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.PLAYLISTS_CANISTER_ID;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./playlists.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the playlists canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./playlists.did.js")._SERVICE>}
 */
export const playlists = createActor(canisterId);
